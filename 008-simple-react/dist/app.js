...
function Counter() {
  const [state, setState] = _Didact__WEBPACK_IMPORTED_MODULE_0__.default.useState(1);
  return _Didact__WEBPACK_IMPORTED_MODULE_0__.default.createElement("h1", {
    onClick: () => setState(c => c + 1)
  }, "Count: ", state);
}

const element = _Didact__WEBPACK_IMPORTED_MODULE_0__.default.createElement(Counter, null);
